					...
					<div class="col-xs-12 text-center" >
						<div class="menu-1">
							<ul>
								...
								<li>
									<a href="departments.html">Talento Pisco</a>
								</li>
								<li>
				...
				<div class="col-md-4 animate-box">
					<div class="services">
						...
						<div class="desc">
							...
							<p>Mejorar la enseñanza y los contenidos educativos en los alumnos de nivel secundaria.</p>
						</div>
					</div>
				</div>
				<div class="col-md-4 animate-box">
					<div class="services">
						...
						<div class="desc">
							...
							<p>Promoviendo el desarrollo de nuevas tecnologías como materia de estudio en los colegios nacionales.</p>
						</div>
					</div>
				</div>
				<div class="col-md-4 animate-box">
					<div class="services">
						...
						<div class="desc">
							...
							<p>Otorgando capacidades a los estudiantes para brindar soluciones innovadoras a problemas comunes.</p>
						</div>
					</div>
				</div>
				...
				<div class="choose">
					...
					<div class="half features-wrap">
						<div class="qbootstrap-heading animate-box"  >
							<h2>Bienvenido al Programa Talento Pisco</h2>
				...
				<div class="choose">
					...
					<div class="half features-wrap">
						<div class="qbootstrap-heading animate-box">
							...
							<p>Es una propuesta de 3 instituciones innovadoras, pioneras y líderes en materia de logros de aprendizaje y tecnología del país, preparada exclusivamente para Pluspetrol en el marco del concurso que busca seleccionar a la(s) institucion(es) que implemente(n) 3 "Proyectos Sociales - Pisco" para mejorar sustancialmente la educación secundaria en la provincia de Pisco.</p>
						</div>
						<div class="features animate-box">
							<span class="icon text-center"><i class="icon-group-outline"></i></span>
							<div class="desc">
						...
						<div class="features animate-box">
							...
							<div class="desc">
								<h3>Pisco Tecnología</h3>
								<p>Educación para el Trabajo Técnico Escolar para los alumnos del 4to y 5to de secundaria con certificación reconocida.</p>
							</div>
						</div>
					</div>
				</div>
				...
				<div class="choose">
					...
					<div class="half features-wrap">
						...
						<div class="features animate-box">
							...
							<div class="desc">
								<h3>Seguimiento</h3>
								<p>Constantemente se hace seguimiento de los indicadores, las cuales nos hacen saber que se va por buen camino.</p>
							</div>
						</div>
					</div>
				</div>
