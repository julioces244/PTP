...
<center><a href="{{ url('imgpa_bandera')}}" class="btnmodules">
        <button style="width: 200px"  type="button" class="btn btn-outline-success"><img src="images/LogosPTP/Pisco_apr.png"></button></a>
        <a href="{{ url('imgpd_bandera')}}" class="btnmodules">
        <button style="width: 150px"  type="button" class="active btn btn-outline-success"><img src="images/LogosPTP/Pisco_dig.png"></button></a>
...
<div class="tabs">
		...
		<!--start tabs-->
			...
			<div class="downloads"><!--start downloads-->
  			...
  			<a href="{{ url('imgpd_bandera')}}" class="btn2 download-btn2">Bandera del Perú</a>
  			<a href="{{ url('#')}}" class="btn2 social-btn2">José de San Martín</a>
        <a href="{{ url('#')}}" class="btn2 social-btn2">Raúl Porras Barrenechea</a>
        <a href="{{ url('#')}}" class="btn2 social-btn2">Renán Elías Olivera</a>
